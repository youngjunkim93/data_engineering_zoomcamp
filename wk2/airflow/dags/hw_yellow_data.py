...
with DAG(
    ...
    dataset_file = f"yellow_tripdata_{range_indicator}.csv"
    ...
    download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> bigquery_external_table_task >> delete_temp_file_task